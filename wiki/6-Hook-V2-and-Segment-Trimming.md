...
python -m app.cli --url "VIDEO_URL" --hook-v2 --white-flash-duration 0.15
```
...
python -m app.cli --url "VIDEO_URL" --hook-v2 --silence-trim --no-broll

# Hook V2 + Full render (no trimming) + Custom font
python -m app.cli --url "VIDEO_URL" --hook-v2 --no-segment-trim --font-style CINEMATIC
