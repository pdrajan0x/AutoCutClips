"""
app.tracker.server — Lightweight HTTP server for the YouTube Tracker.

Standard library only (http.server); serves the static frontend plus the JSON
API endpoints. Run with: python -m app.tracker.server
"""
...
class TrackerHandler(BaseHTTPRequestHandler):
    ...
    def _route_post(self, path, query):
        ...
        if path == "/api/videos/manual":
            ...
            if existing:
                return self._send_error_json(409, "This video has already been added.")
