    ...
    <div className="fade-in">
      <div className="page-header">
        <div>
          ...
          <p>Generate viral short clips from long videos</p>
        </div>
      </div>
        ...
        <div className="card" style={{ marginBottom: '16px' }}>
          ...
          {mode === 'reuse' && (
            <div className="form-group">
              ...
              />
              <p className="form-hint" style={{ marginTop: '4px' }}>Bypass the download by reusing an existing job ID. (When using Clone &amp; Rerun, leave this field filled in.)</p>
            </div>
          )}
        </div>
