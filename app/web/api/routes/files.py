"""
app.web.api.routes.files — File upload and output serving endpoints.
"""
...
# Resolve the repository root (4 levels up from app/web/api/routes).
...
async def upload_video(file: UploadFile = File(...)) -> dict:
    ...
    return {
        ...
        "message": f"Upload complete: {safe_name} ({size_mb:.1f} MB)",
    }
